...
//button1 button1;
   ...
   LoginFrm loginFrm;
    ...
    //  add(loginFrm);
     loginFrm.setVisible(false);  // revisar si debe arrancar en false o true

    registroFrm = new RegistroFrm();
   //  add(registroFrm);
    registroFrm.setVisible(false);         //lo quitamos para que no duplique al iniciar el principal  , pasa de true a false?
    ...
    @SuppressWarnings("unchecked")
        ...
        private void initComponents() {
                ...
                PanelMenu.setBackground(new java.awt.Color(86, 168, 240));

                jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gestionparking/logo parking.png"))); // NOI18N
                jLabel1.setMaximumSize(new java.awt.Dimension(1200, 385));
                jLabel1.setMinimumSize(new java.awt.Dimension(1200, 385));

                jLabel2.setFont(new java.awt.Font("Segoe UI Semilight", 0, 36)); // NOI18N
                jLabel2.setForeground(new java.awt.Color(255, 255, 255));
                jLabel2.setText("GestiónParking");
                ...
                button1.setLabel("Ingresar Vehículo");
                ...
                button2.setBackground(new java.awt.Color(153, 255, 204));
                button2.setFont(new java.awt.Font("Segoe UI Symbol", 1, 12)); // NOI18N
                button2.setForeground(new java.awt.Color(255, 255, 255));
                button2.setLabel("Retirar Vehículo");
                ...
                button3.setBackground(new java.awt.Color(153, 255, 204));
                button3.setFont(new java.awt.Font("Segoe UI Symbol", 1, 12)); // NOI18N
                button3.setForeground(new java.awt.Color(255, 255, 255));
                button3.setLabel("Listar Vehículos");
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        panelingresarvehiculo.setVisible(true);//  arranca con esta primera opcion
        panelListarVehiculos.setVisible(false);
        panelretirarvehiculo.setVisible(false);
     ...
     */
    public static void main(String args[]) {        // SE PROGRAMA EL ARRANQUE DE LA APLICACION
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {    //PRIMER ARRANQUE

                new LoginFrm().setVisible(true);   // colocado como primer inicio
               LoginFrm EXIT_ON_CLOSE;   // PARA QUE SE CIERRE DESPUES DE HACER SU TRABAJO


             new RegistroFrm().setVisible(false);         // colocado como segundo en el inicio despues del login

                new Principal().setVisible(false);   //cambiado por true ,cuando inicia sin el login ni registro
